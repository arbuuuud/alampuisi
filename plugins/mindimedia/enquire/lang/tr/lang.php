...
return [
    'plugin' => [
        'name' => 'Enquire',
        'description' => 'Sağlam enquire platformu.'
    ],
    'enquire' => [
        'menu_label' => 'Enquire',
        'menu_description' => 'Gönderileri Yönet',
        'posts' => 'Gönderiler',
        'create_post' => 'enquire gönderisi',
        'categories' => 'Kategoriler',
        'create_category' => 'enquire kategorisi',
        'tab' => 'Enquire',
        'access_posts' => 'Gönderileri yönet',
        'access_categories' => 'Enquire kategorilerini yönet',
    ...
    'posts' => [
        'list_title' => 'Enquire gönderilerini yönet',
        'category' => 'Kategori',
    ...
    'settings' => [
        ...
        'category_slug_description' => "Verilen kısa URLi kullanarak enquire kategorisini görüntüle. Bu özellik şu anki aktif kategoriyi işaretlemek için varsayılan kısmi bileşeni tarafından  kullanılır",
