...
return [
    'plugin' => [
        'name' => 'Enquire',
        'description' => 'Solidna platforma enquireera'
    ],
    'enquire' => [
        'menu_label' => 'Enquire',
        'menu_description' => 'Zarządzaj enquireowymi postami',
        'posts' => 'Posty',
        'create_post' => 'utwórz post',
        'categories' => 'Kategorie',
        'create_category' => 'kategoria enquirea',
        'tab' => 'Enquire',
        'access_posts' => 'Zarządzaj enquireowymi postami',
        'access_categories' => 'Zarządzaj enquireowymi kategoriami',
        'access_other_posts' => 'Zarządzaj enquireowymi postami innych użytkowników',
    ...
    'posts' => [
        'list_title' => 'Zarządzaj enquireowymi postami',
        'category' => 'Kategoria',
    ...
    'settings' => [
        ...
        'category_description' => 'Wyświetla listę enquireowych kategorii na stronie.',
        'category_slug' => 'Alias kategorii',
        'category_slug_description' => "Look up the enquire category using the supplied slug value. This property is used by the default component partial for marking the currently active category.",
